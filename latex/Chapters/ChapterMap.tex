...
\begin{table}[H]
    \caption{General map of load profiles}
    ...
    \begin{tabular}[c]{@{}l@{}}power \\ (avg)\end{tabular}          & X &   &   & X & X \\ \hline
    ...
    time array &
      ...
      X &
      1 &
      \begin{tabular}[c]{@{}l@{}}1\\ 2\\ 3\end{tabular} &
      \begin{tabular}[c]{@{}l@{}}1\\ (3)\end{tabular} \\ \hline
    \end{tabular}
\end{table}

Based on table above, it is possible to extract main features.
