...
They will be an essential part of European Union's plan to reach zero-energy buildings
...
where besides users usage pattern system would also obtain weather forecasts from the internet.
...
\cite{energy_stealing_2018} uses anomaly detection algorithms and load profiling to detect energy lost due to non-technical losses.
This occurs after the smart-meter is exposed to cyber or mechanical attack and its measurements are off. 
