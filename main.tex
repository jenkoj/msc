...
\begin{acknowledgements}
  ...
  Rad bi se zahvalil naslednjim osebam, brez katerih ta magistrska naloga ne bi bila mogoča. 
  Doc. znan. sod. Carolini Fortuni in izr. prof. dr. Marku Meži za vso podporo in usmeritve, ki sta mi jih nudila pri izvedbi raziskave.
  Znanstveni in odprtokodni skupnosti, ki je zagotovila podatke in orodja, ki so bila uporabljena v delu. 
  Hkrati bi se rad zahvalil prijateljem in sodelavcem, ki so z razpravami pomagali spodbuditi ideje, ki so bile predstavljene v magistrskem delu. 
  Zahvaljujem se moji družini, ki me je navdihovala, podpirala in spodbujala, da sem se odločil za študij. 
  Nazadnje bi se zahvalil svoji partnerki Niki, ki me je skozi vsa leta študija podpirala v vseh možnih pogledih.
