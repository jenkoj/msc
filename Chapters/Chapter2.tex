...
Knowing the following three features, we can know the amount of energy consumed by the user.
...
Figure above \ref{fig:map_fig}, uses features from previous subsection \ref{sec:subfeatures}. 
...
Table \ref{tab:classified_profiles} shows which profiles were researched and which were not.
...
Based on Table \ref{tab:our_rd} we will use the following profiles in the following chapters.
