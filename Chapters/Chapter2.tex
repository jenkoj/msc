...
\begin{table}[H]
  ...
  \centering
	...
	\hline
	\begin{tabular}[c]{@{}l@{}}\end{tabular}                                                   & \multicolumn{4}{c|}{Per-building}                                                                                               & \multicolumn{4}{c|}{Per-appliance}                                                                                           & \multicolumn{4}{c|}{\begin{tabular}[c]{@{}c@{}}Per-building\\ per-appliance\end{tabular}}                                                         \\ \cline{2-13}
