...
% The publication by \cite{sne_energ} compared various dimensionality reduction techniques for clustering and visualisation of load profiles.
...
% In all cases, work has been done with the power load profile, whereas in this case, we will try to find similarities between activation profiles using t-SNE algorithm.
% Most of the publications used one time dimensions, whereas we will use two time dimensions.
...
By slicing this data to 1 month intervals and convering this data to load pofile samples, we were able to obtain 5218 samples.
\subsection{Datasets}
...
The goal of the chapter was to show how data is related in high-dimensional space.
