...
The clustering of load profiles was researched many times before, as it was described in related work Chapter \ref{chapter2}.
...
The structure of datasets will be analyzed in larger depth in the next chapter \ref{chapter6}. 
...
The Figure \ref{fig:tsne_pb_img_scatter_allall} below presents the actual load profile for each sample. 
...
Figure \ref{fig:tsne_pa_img_scatter_all_fridge} is a good example of how load profiles with little to no human interaction, can look a lot different. 
...
the household does not use microwave as much. The most interesting load profiles are in the middle of the 
