...
By combining weekly wind forecasts, weekly cloud coverage, and users consumption profiles energy providers could notify users to turn on their appliances at peak usage times.
...
Combining the Figures \ref{fig:solar thermal pumping station} and \ref{fig:light} enables us to differentiate between the two. 
