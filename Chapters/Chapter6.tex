...
After combining results from all 26 buildings, Table \ref{tab:ec_res} can be populated.
First Table \ref{tab:ec_res_weekend} shows that the algorithm is 79.43 \% efficient at detecting true anomalies. 
