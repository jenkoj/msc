...
When such changes do occur, it is important that the algorithms has methods in place, that enable them to adjust to the new routine.
The simplest approach would be to use weights, to put more attention to more recent data and less attention to older data.
