...
Using the matrix \ref{arr:act_mat} we can compile an algorithm that will use current activations 
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \node at (5.5,0){if SUM >= 2 = not an anomaly };
    \end{tikzpicture}
...
By repeating the process one more time the result increases to 80.20 \%, since all outliers were removed, the result converges toward this value. 
