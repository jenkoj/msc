...
In the case of t-SNE, we have used normalised per-building LPs with very little preprocessing, whereas in elderly care algorithm, we have used per-building per-appliance LPs with extensive pre-processing to extract applicnes that could help us detect the routine.
