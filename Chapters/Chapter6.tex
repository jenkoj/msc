...
The results of the study suggest that the method for detecting anomalies is effective, but it is difficult to compare the results to those of a normal learning model because the train and test sets were different. While the results do indicate that the true performance of the method is around the expected 80% mark, it is challenging to determine how the results would have differed if the train and test sets had been the same.
